// pages/service/questionList/questionList.js
...
Page({
  ...
  onLoad: function (options) {
    ...
    jyTool.toolBar.initJYToolBar(this, ['全部', '未回复', '已回复'], 'selseItemAction', 40);
  ...
  loadData: function () {
    ...
    that.isLoading = true;
    util.getQuestionList({ offset: that.offset, is_my: "1", status: that.status }, function (data) {
